...
export default function Homepage() {
  return (
    <div className="container center">
      <div className="card">
        <h1 style={{ marginBottom: '0.5em' }}>Welcome to Learn-Swiss</h1>
        ...
        <p><b>To any potential employers</b> who have visited this page as part of a job application. Please understand this site is not currently public and still under construction with regular deployments and feature testing.</p>
      </div>
    </div>
  );
}
